...
parser.add_argument('--src_path', default='/home/chx/Work/semantic-kitti/sequences', help='source dataset path [default: None]')
parser.add_argument('--dst_path', default='/home/chx/Work/semantic-kitti-randla/sequences', help='destination dataset path [default: None]')
...
for seq_id in tqdm(seq_list, total=len(seq_list)):
    ...
    if int(seq_id) < 11:
        ...
        # scan_list = scan_list[0:len(scan_list):4]
