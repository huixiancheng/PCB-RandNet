...
parser.add_argument('--src_path', default='/home/chx/Work/SemanticPOSS_dataset/sequences', help='source dataset path [default: None]')
parser.add_argument('--dst_path', default='/home/chx/Work/SemanticPOSS_dataset_grid_0.01/sequences', help='destination dataset path [default: None]')
parser.add_argument('--grid_size', type=float, default=0.01, help='Subsample Grid Size [default: 0.06]')
...
for seq_id in tqdm(seq_list, total=len(seq_list)):
    # seq_id = '03'
    ...
    for scan_id in tqdm(scan_list, total=len(scan_list)):
        # print(scan_id)
