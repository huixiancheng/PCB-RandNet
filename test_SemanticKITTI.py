...
parser.add_argument('--result_dir', default='test_pred', help='Dump dir to save prediction [default: result/]')
...
class Tester:
    def __init__(self):
        ...
        test_dataset = SemanticKITTI('test', test_id=FLAGS.test_id, batch_size=FLAGS.batch_size,
                                    sampling_way=FLAGS.sampling, step=FLAGS.step, grid=FLAGS.grid)
